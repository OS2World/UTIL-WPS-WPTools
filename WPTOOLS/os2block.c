...
*************************************************************/
PNODE _System PathFromObject(HINI hIniSystem, HOBJECT hObject, PSZ pszFname, USHORT usMax, PBYTE pfHandleUsed)
{
USHORT usObjID;
   ...
   return GetPartName(pHandlesBuffer, ulHandlesSize, usObjID, pszFname, usMax, pfHandleUsed);
}

/*************************************************************
* Get the object partname as specified in usID
*************************************************************/
PNODE _System GetPartName(PBYTE pHandlesBuffer, ULONG ulBufSize, USHORT usID, PSZ pszFname, USHORT usMax, PBYTE pfHandleUsed)
{
PDRIV pDriv = NULL;
PNODE pNode;
PBYTE p, pEnd;
